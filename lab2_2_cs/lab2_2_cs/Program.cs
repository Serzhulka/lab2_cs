...
namespace lab2_2_cs
{
    class Program
    {
        ...
        public static void floatingPoint(string num1, string num2)
        {
            ...
            Console.WriteLine("Additional bit: " + (mantissa1 + mantissa2 > Math.Pow(2, 23) && (first - Math.Abs(first) == 0) && (second - Math.Abs(second) == 0)));
            int new_expo;
            ...
            Console.WriteLine("\nAdd significands:\nMASTISSA: " + Convert.ToString(sum_man, 2));
